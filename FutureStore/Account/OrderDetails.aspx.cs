...
using FutureStore.Data_Access;

namespace FutureStore.Account
{
    public partial class OrderDetails : System.Web.UI.Page
    {
        ...
        protected void MyList_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                FutureStore.Data_Access.VewOrderDetail myCart = new Data_Access.VewOrderDetail();
                myCart = (FutureStore.Data_Access.VewOrderDetail)e.Row.DataItem;
